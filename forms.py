...
class NewCaseForm(FlaskForm):
    ...
    photos = MultipleFileField('Upload Photos (Multiple clear, front-facing photos are best)', validators=[DataRequired(), validate_image_files], render_kw={'accept': '.jpg,.jpeg,.png,.gif,.bmp,.webp'})
